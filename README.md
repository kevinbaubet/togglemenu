...
| timeout                           | integer        | 0                 | Temps d'attente avant de désactiver le survol                                                          |
...
| backLink                                              | boolean        | false                                                    | Ajouter un lien sur le titre du niveau parent en mode d'affichage 'layout'                                                                                                                                                                                                              |
